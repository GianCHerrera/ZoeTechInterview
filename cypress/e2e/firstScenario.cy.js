...
describe('template spec', () => {
  it('passes', () => {
    ...
    cy.get('.styles_newClientOptions__options__YK_tM button', { timeout: 10000 }).first().click();
    cy.get('.next-button', { timeout: 10000 }).click();
    cy.get('#input-search', { timeout: 10000 }).type('Eleanora Schneider');
    cy.get('.styles-module_searchClient__option__e6fRD', { timeout: 10000 }).click();
    cy.get('.next-button', { timeout: 10000 }).click();
    ...
    cy.get('.next-button', { timeout: 10000 }).click();
    cy.get('.styles_householdSuccessView__successMessage__ARlV0', { timeout: 10000 }).should('exist');
    cy.get('.styles_link__modActive__2xcl0', { timeout: 10000 }).should('exist');
